...
public enum Message {
    ...
    NO_PERM_SETWARP("§7Your faction §cdoes not §7allow you to update warps.", ""),
    WARP_MUST_BE_IN_TERRITORY("§7Faciton warps must be located within faction territory.", ""),
    WARP_ALREADY_EXISTS("§7A warp with that name already exists.", ""),
    YOU_WILL_BE_TPD_IN_N_SECONDS("§7You will be teleported in §a%sec% §7seconds.", ""),
    ...
    TPD_TO_WARP("§7You §asuccessfully §7teleported yourself to §a%warp%§7.", ""),
    REMOVED_WARP("§6%player% §7removed the warp §a%warp%§7.", ""),
    NO_PUPPET_PERM("§7Your faction §cdoes not §7allow you to puppet factions.", ""),
    ALREADY_PUPPETED("§7This faction §cis already §7a puppet of someone.", ""),
    NO_SETFLAG_PERM("§7Your faction §cdoes not §7allow you to set their flag.", ""),
    ITEM_IS_NOT_A_BANNER("§7You can §conly §7set a banner as your faction-flag.", ""),
    SET_FLAG("§6%player% §7changed your factions flag.", ""),
    NO_BAN_PERM("§7Your faction §cdoes not §7allow you to ban people.", ""),
    NO_UNBAN_PERM("§7Your faction §cdoes not §7allow you to unban people.", ""),
    ...
    CANT_ACCESS_WHATS_NOT_YOURS("§7You §ccan't §7give access to a chunk that does not belong to your faction.", ""),
