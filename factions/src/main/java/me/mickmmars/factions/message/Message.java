...
public enum Message {
    ...
    PLAYER_NOT_LEADER("§cOnly your faction-leader can perform this command.", ""),
    NO_STAFF_ONLINE("§7There is no staff-member online at the moment. But they got notified over discord, so they can come online as fast as possible!", ""),
    ...
    PLAYER_ADDED_PERMISSION_TO_GROUP_FAC("§6%player% §7added the permission §b%perm% §7to %rank%§7.", ""),
    PLAYER_REMOVED_PERMISSION_FROM_GROUP_FAC("§6%player% §7removed the permission §b%perm% §7from %rank%§7.", ""),
    ...
    NO_1PT_UPGRADE("§7Your faction §cdoes not §7have the ONEPUPPET upgrade!", ""),
    NO_2PT_UPGRADE("§7Your faction §cdoes not §7have the TWOPUPPET upgrade!", ""),
    NO_3PT_UPGRADE("§7Your faction §cdoes not §7have the THREEPUPPET upgrade!", ""),
    TOO_MANY_PUPPETS("§7Your faction §ccannot §7have more than 3 puppets.", ""),
    ...
    PLAYER_HAS_SET_RANKPREFIX("§6%player% §7has set your factions %rank%§7-prefix to §a%prefix%§7.", ""),
    ALLYCHAT_ENABLED("§dAllychat §aenabled§7.", ""),
    ALLYCHAT_DISABLED("§dAllychat §cdisabled§7.", ""),
    NO_PUPPETMANAGE_PERM("§7Your faction §cdoes not §7allow you to manage puppets.", ""),
    ALREADY_PUPPET("§7This faction is already a puppet.", ""),
    FAC_PUPPETED("§7Faction §b%puppet% §7got puppeted by §b%overlord%§7.", ""),
    LEADER_NOT_ONLINE("§7The leader of that faction §cis not §7online.", ""),
    PUP_REQ_DENIED("§7Denied puppet request.", ""),
    SENT_PUPPET_REQ("§7You sent §b%faction% §7a puppeting request.", ""),
    ...
    CB_ACCEPTED("§7You accepted the CB with the Id §b%id%§7.", ""),
    CB_REJECTED("§7You rejected the CB with the Id §b%id%§7.",""),
    CB_REVOKED("§7You revoked the CB with the Id §b%id%§7.", ""),
    CB_DOESNT_EXIST("§7This CB does not exist.", ""),
    NO_APPROVED_CBS("§7Your faction does not have any approved CBs to start a war.", ""),
    NO_OPEN_CBS_ATM("§7There are no open CBs at the moment.", ""),
    WAR_STARTED("§7A war between §b%attacker% §7and §b%defender% §7started with the CB §c%cb%§7.", ""),
    ALREADY_IN_WAR("§7Your faction is already in a war.", ""),
