...
public class PlayerCappingFailedEvent extends Event implements Cancellable {
    ...
    public PlayerCappingFailedEvent(Player capper, CasusBelli cb, FactionData nationGettingCapped) {
        this.capper = capper;
        this.cb = cb;
