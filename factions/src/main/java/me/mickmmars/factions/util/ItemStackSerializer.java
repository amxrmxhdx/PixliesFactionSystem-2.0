...
public class ItemStackSerializer {
    ...
    private static void setBannerMeta(ItemStack item, List<Pattern> patterns) {
        try{
    ...
    private static List<Pattern> getBannerMeta(ItemStack item) {
        if(!(item.getItemMeta() instanceof BannerMeta)) return null;
